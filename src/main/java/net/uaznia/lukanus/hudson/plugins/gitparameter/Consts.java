...
public class Consts {
    ...
    public static final String PARAMETER_TYPE_ANNOTATED_TAG = "PT_ANNOTATED_TAG";
    ...
    public static boolean isParameterTypeCorrect(String type) {
        return type.equals(PARAMETER_TYPE_TAG) || type.equals(PARAMETER_TYPE_ANNOTATED_TAG)
        		|| type.equals(PARAMETER_TYPE_REVISION) || type.equals(PARAMETER_TYPE_BRANCH)
        		|| type.equals(PARAMETER_TYPE_TAG_BRANCH) || type.equals(PARAMETER_TYPE_PULL_REQUEST);
    }
    ...
    public static boolean isAnnotatedTagType(String type) {
        return type.equalsIgnoreCase(PARAMETER_TYPE_ANNOTATED_TAG);
    }
